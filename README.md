...
- **[Documentation/README.md](Documentation/README.md)** — Quick start, API, project structure, tools, guardrails, router.
- **[Documentation/ARCHITECTURE_DESIGN.md](Documentation/ARCHITECTURE_DESIGN.md)** — Full architecture, diagrams, deployment, observability.
